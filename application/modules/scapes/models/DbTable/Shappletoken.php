...
/**
 * Scapes Apple token table management class.
 *
 * @copyright  2014 Scapehouse
 */

class Scapes_Model_DbTable_Shappletoken extends Zend_Db_Table_Abstract
{
    protected $_name = "sh_scapes_device_token"; // The table name.
     ...
     * @param int $badgeCount Numeric value to set the counter.
     *
     * @return void
     */
    function updateBadgeCount($userID, $badgeCount)
    {
        ...
        $this->_db->update($this->_name, array("badge_count" => $badgeCount), "user_id = {$userIDQ}");
    }
