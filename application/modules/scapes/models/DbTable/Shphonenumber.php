...
/**
 * Scapes phone number management class.
 *
 * @copyright  2014 Scapehouse
 */

class Scapes_Model_DbTable_Shphonenumber extends Zend_Db_Table_Abstract
{
    protected $_name = "sh_scapes_phone_number"; // The table name.
