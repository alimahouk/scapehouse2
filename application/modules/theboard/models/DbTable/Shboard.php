...
class Theboard_Model_DbTable_Shboard extends Zend_Db_Table_Abstract
{
    protected $_name = "sh_board"; // The table name.
    ...
    function deleteBoard($boardID)
    {
        ...
        $this->_db->delete("sh_board_post", array(
            "board_id = ?" => $boardID
        ));
    }
    ...
    {
        $this->_db->insert("sh_board_request", array(
                "user_id" => $userID,
                "board_id" => $boardID)
        );
    }
    ...
    {
        $this->_db->delete("sh_board_request", array(
            "user_id = ?" => $userID,
            "board_id = ?" => $boardID
        ));
    }
    ...
    function join($userID, $boardID)
    {
        ...
        $this->_db->delete("sh_board_suggestion", array(
            "user_id = ?" => $userID,
            "board_id = ?" => $boardID
        ));

        $this->_db->insert("sh_board_membership", array(
                "member_id" => $userID,
                "board_id" => $boardID,
    ...
    {
        $this->_db->delete("sh_board_membership", array(
            "member_id = ?" => $userID,
            "board_id = ?" => $boardID
        ));
    }
    ...
    {
        $query = $this->_db->select()
        ->from("sh_board_membership", "COUNT(*)")
        ->where("board_id = ?", $boardID);
    ...
    function getMemberPreview($userID, $boardID)
    {
        ...
        $query = $this->_db->select()->from("sh_user")
                ->join("sh_board_membership", "sh_board_membership.member_id = sh_user.user_id AND sh_board_membership.board_id = {$boardIDQ}", array())
    ...
    {
        $query = $this->_db->select()->from("sh_user")
                ->join("sh_board_membership", "sh_board_membership.board_id = {$boardID} AND sh_board_membership.member_id = sh_user.user_id", array())
                ->limit(200, 0);
    ...
    {
        $query = $this->_db->select()->from("sh_user")
                ->join("sh_board_request", "sh_board_request.board_id = {$boardID} AND sh_board_request.user_id = sh_user.user_id", array())
                ->limit(5000, 0);
    ...
    function boardsForUser($userID)
    {
        ...
        $query = $this->_db->select()->from("sh_board")
                ->join("sh_board_membership", "sh_board_membership.board_id = sh_board.board_id AND sh_board_membership.member_id = {$userIDQ}", array())
                ->limit(500, 0);
    ...
    function addBoardSuggestion($userID, $boardID)
    {
        ...
        {
            $this->_db->insert("sh_board_suggestion", array(
                "user_id" => $userID,
                "board_id" => $boardID)
            );
        }
    ...
    function getRecommendedBoardsForUser($userID)
    {
        ...
        $query = $this->_db->select()->from("sh_board")
                ->join("sh_board_suggestion", "sh_board_suggestion.board_id = sh_board.board_id AND sh_board_suggestion.user_id = {$userIDQ}", array())
                ->order(new Zend_Db_Expr('RAND()'))
                ->limit(20, 0);
    ...
    function registerView($userID, $threadID)
    {
        ...
        if ( !$result )
        {
            $this->_db->insert("sh_board_view", array(
                "viewer_id" => $userID,
                "post_id" => $threadID,
                "timestamp" => gmdate("Y-m-d H:i:s", time())
            ));
    ...
    {
        $this->_db->insert("sh_board_post", array(
        ...
        $postID = $this->_db->lastInsertId("sh_board_post");
    ...
    function editPost($postID, $text)
    {
        ...
        $this->_db->update("sh_board_post", array(
    ...
    function deletePost($postID)
    {
        ...
        $this->_db->delete("sh_board_view", array(
            "post_id = ?" => $postID
        ));
    }
